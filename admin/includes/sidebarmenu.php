<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<!-- New Tour Guides Menu -->
			<li id="menu-academico"><a href="#"><i class="fa fa-users" aria-hidden="true"></i><span> Tour Guides</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="add-tour-guide.php">Add New Guide</a></li>
					<li id="menu-academico-avaliacoes"><a href="manage-tour-guides.php">Manage Guides</a></li>
				</ul>
			</li>
